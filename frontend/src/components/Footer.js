    ...
    >
      ...
      >
        ...
        <div style={{ flex: 2, minWidth: 260 }}>
          ...
          >
            GlobeTrekker brings your travel dreams to life with curated
            destinations, seamless planning, and unforgettable experiences.
          </p>
        </div>
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 2 }}>
            <li>
              <Link to="/register" style={{ color: "#b8c8dc", textDecoration: "none" }}>
                Register
              </Link>
            </li>
            <li>
              <Link to="/about" style={{ color: "#b8c8dc", textDecoration: "none" }}>
                About Us
              </Link>
            </li>
            <li>
              <Link to="/contact" style={{ color: "#b8c8dc", textDecoration: "none" }}>
                Contact Us
              </Link>
            </li>
          </ul>
      ...
      >
        ...
        <div style={{ flex: 2, textAlign: "right" }}>
          <Link to="/privacy" style={{ color: "#b8c8dc", margin: "0 10px", textDecoration: "none" }}>
            Privacy Policy
          </Link>
          <span>|</span>
          <Link to="/terms" style={{ color: "#b8c8dc", margin: "0 10px", textDecoration: "none" }}>
            Terms & Conditions
          </Link>
          <span>|</span>
          <Link to="/faq" style={{ color: "#b8c8dc", margin: "0 10px", textDecoration: "none" }}>
            FAQ
          </Link>
        </div>
      </div>
